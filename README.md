...
You should open programm as administrator,if exe does not work open the exe that is in debug.‼️‼️!!You must have installed vcredistx64(for 64 bit) vcredist x86(32 bit)!!!‼️‼️
